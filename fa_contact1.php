				...
				<div class="inner">
					<header class="align-center">
						    <div class="container" style="align:center;">
                              <form style="margin-left:200px; margin-top:30px;" action=" <?php htmlspecialchars($_SERVER['PHP_SELF']); ?>" method="post">
                                ...
                                <div class="row">
                                  ...
                                  <div class="col-75">
                                    <input type="text" name="name" id="name" value=<?php echo $arr['name'];?>>
                                  </div>
                                </div>
